...
public class CassandraDDLManagerImpl  extends SimpleCassandraClientImpl implements CassandraDDLManager{
	...
	private void createDDLs() {
		//keeps all logs collected from the system (same as logs in mongodb). not used at the moment
		...
		//counts users activities in the system. previously it was planned to be used for user activity recommendation. probably it will not be used later
		...
		//counts users activities for specific learning goal. Should be processed by spark job to analyze who are most active users for the learning goal
