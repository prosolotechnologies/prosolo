...
public class CassandraDDLManagerImpl extends SimpleCassandraClientImpl
    ...
    private CassandraDDLManagerImpl() {
        ...
        logger.info("CassandraDDLManagerImpl init finished");
    }
    ...
    private void createDDLs() {
        ...
        String notificationDataDDL = "CREATE TABLE IF NOT EXISTS "
    ...
    public void checkIfTablesExistsAndCreate(String keyspacename) {
        logger.info("Check if Tables exists and Create for keyspace:" + keyspacename);
        ...
        logger.info("Check if Tables exists and Create finished for keyspace:" + keyspacename);
