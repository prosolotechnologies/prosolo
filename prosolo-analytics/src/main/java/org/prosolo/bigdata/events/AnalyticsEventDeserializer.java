...
public class AnalyticsEventDeserializer  implements JsonDeserializer<AnalyticsEvent>{
	...
	public AnalyticsEvent deserialize(JsonElement json, Type typeOfT,
		...
		AnalyticsEvent event=gson.fromJson(message.toString(), AnalyticsEvent.class);
		return event;
	}
