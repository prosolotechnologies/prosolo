...
public abstract class AbstractESIndexer {
	private static Logger logger = Logger.getLogger(AbstractESIndexer.class
			.getName());
	...
	public void delete(String id, String indexName, String indexType) {
		...
		try {
			deleteResponse = ElasticSearchConnector.getClient()
					.prepareDelete(indexName, indexType, id).execute()
					.actionGet();
	...
	public void update(XContentBuilder builder, String id, String indexName,
			String indexType) {
		...
		try {
			...
			UpdateResponse updateResponse = client
					.prepareUpdate(indexName, indexType, id).setDoc(builder)
					.execute().actionGet();
	...
	public void indexDocument(XContentBuilder builder, String indexId,
	...
	public void addMapping(Client client, String indexName, String indexType)
		...
		String mappingPath = "/org/prosolo/bigdata/es/mappings/" + indexType
				+ "-mapping.json";
		String mapping = null;
