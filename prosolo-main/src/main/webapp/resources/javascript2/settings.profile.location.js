function initializeMap(locationName, lat, lng) {
	...
	var map = new google.maps.Map($('.location .map-canvas')[0], mapOptions);
	var latitude = $('.latitude');
	var longitude = $('.longitude');
	
	var input = /** @type {HTMLInputElement} */$('.location .searchLocationTextField')[0];
...
function locateMe() {
	...
	var map = new google.maps.Map($('.location .map-canvas')[0], myOptions);
