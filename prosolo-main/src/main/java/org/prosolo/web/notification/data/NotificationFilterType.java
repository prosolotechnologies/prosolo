...
public enum NotificationFilterType {
	...
	GradeAdded(NotificationType.GradeAdded, "Assessments received", List.of(PageSection.STUDENT)),
	...
	Assessor_Withdrew_From_Assessment(NotificationType.ASSESSOR_WITHDREW_FROM_ASSESSMENT, "Withdrawn assessments", List.of(PageSection.STUDENT)),
	Assessor_Assigned_To_Assessment(NotificationType.ASSESSOR_ASSIGNED_TO_ASSESSMENT, "Assessors assigned to you", List.of(PageSection.STUDENT)),
	Assigned_To_Assessment_As_Assessor(NotificationType.ASSIGNED_TO_ASSESSMENT_AS_ASSESSOR, "You assigned as assessor", List.of(PageSection.STUDENT)),
	...
	Assessment_Tokens_Number_Updated(NotificationType.ASSESSMENT_TOKENS_NUMBER_UPDATED, "Assessment tokens updates", List.of(PageSection.STUDENT));
