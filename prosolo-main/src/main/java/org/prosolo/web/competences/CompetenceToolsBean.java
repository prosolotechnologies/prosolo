...
@ManagedBean(name = "competenceToolsBean")
@Component("competenceToolsBean")
@Scope("view")
public class CompetenceToolsBean implements Serializable {

	private static final long serialVersionUID = -6145577969728042249L;

	private static Logger logger = Logger.getLogger(CompetenceToolsBean.class);
