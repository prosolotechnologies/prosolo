...
public class Paginator {
	...
	public Paginator(int numberOfResults, int limit, int currentPage, boolean generateAllLinks, String missingLinksOutput) {
		this.numberOfResults = numberOfResults;
		this.limit = limit;
		this.currentPage = currentPage;
	...
	public List<PaginationLink> generatePaginationLinks() {
		...
		if(generateAllLinks) {
			...
			//>= numberOfPages - 1 because last page link should always be generated
