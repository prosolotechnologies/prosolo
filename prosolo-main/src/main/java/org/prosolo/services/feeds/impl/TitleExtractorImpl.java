...
import org.prosolo.services.feeds.TitleExtractor;
 ...
 *
 */
@Service("org.prosolo.services.feeds.TitleExtractor")
public class TitleExtractorImpl implements TitleExtractor {
	...
	private final class ContentType {
		private Pattern CHARSET_HEADER = Pattern.compile("charset=([-_a-zA-Z0-9]+)", Pattern.CASE_INSENSITIVE | Pattern.DOTALL);
