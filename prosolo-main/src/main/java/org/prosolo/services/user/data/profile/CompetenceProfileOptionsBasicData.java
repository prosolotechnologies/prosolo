...
@AllArgsConstructor
@Getter
public class CompetenceProfileOptionsBasicData implements Serializable {

    private static final long serialVersionUID = -1285806190642956460L;

    private final long targetCompetenceId;
    private final List<SelectableData<Long>> evidence;
