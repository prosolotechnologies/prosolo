...
@Service("org.prosolo.services.authentication.OAuthValidator")
public class OAuthValidatorImpl implements OAuthValidator  {
     ...
     */
    public OAuthValidatorImpl(long maxTimestampAgeMsec, double maxVersion) {
    ...
    /* (non-Javadoc)
	 * @see org.prosolo.services.authentication.impl.OAuthValidator#validateMessage(net.oauth.OAuthMessage, net.oauth.OAuthAccessor)
	 */
    @Override
