...
public class LearningGoalFilter extends Filter{
	...
	public long getSelectedParticipant() {
		return selectedParticipant;
	}
	public void setSelectedParticipant(long selectedParticipant) {
	...
	public void removeTargetCompetence(long targetCompetenceId) {
		if (targetCompetences.contains(targetCompetenceId)) {
			this.targetCompetences.remove(targetCompetenceId);
		}
