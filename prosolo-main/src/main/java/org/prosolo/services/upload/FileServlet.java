...
public class FileServlet extends HttpServlet {
	...
	private static final long serialVersionUID = -4830675111993537771L;
...
//		this.basePath = getServletContext().getRealPath(getInitParameter("basePath"));
		this.basePath = Settings.getInstance().config.fileManagement.uploadPath;
		//this.basePath=Settings.getInstance().config.fileManagement.fileStoreServiceUrl+"/"+Settings.getInstance().config.fileManagement.fileStoreBucketName;
