...
public class ProSoloConfigurationProvider extends HttpConfigurationProvider {
	...
	public Configuration getConfiguration(final ServletContext context) {
		return ConfigurationBuilder.begin()
				...
				.addRule(Join.path("/manage/instructors/{id}/reassignStudents").to("/manage/reassign.xhtml"))
				.addRule(Join.path("/manage/instructors/{id}/edit").to("/manage/instructor-add.xhtml"))
				.addRule(Join.path("/manage/instructors/new").to("/manage/instructor-add.xhtml"))
