...
public class RewriteConfigurationProvider extends HttpConfigurationProvider {
	...
	public Configuration getConfiguration(final ServletContext context) {
		return ConfigurationBuilder.begin()
				...
				.addRule(Join.path("/credentials/{credId}/{compId}/assessments/self").to("/competence-self-assessment.xhtml"))
				.addRule(Join.path("/credentials/{credId}/{compId}/assessments/instructor").to("/competence-instructor-assessment.xhtml"))
                .addRule(Join.path("/credentials/{credId}/{compId}/assessments/peer").to("/competence-peer-assessments.xhtml"))
				.addRule(Join.path("/credentials/{credId}/{compId}/assessments/peer/{assessmentId}").to("/competence-peer-assessment.xhtml"))
