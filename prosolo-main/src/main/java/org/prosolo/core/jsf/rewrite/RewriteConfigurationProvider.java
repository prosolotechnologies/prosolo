...
public class RewriteConfigurationProvider extends HttpConfigurationProvider {
	...
	public Configuration getConfiguration(final ServletContext context) {
		return ConfigurationBuilder.begin()
				...
				.addRule(Join.path("/profile/{studentId}/credentials/{credId}/assessments/self").to("/credential-self-assessment-profile.xhtml"))
				.addRule(Join.path("/credentials/{id}/assessments/instructor").to("/credential-instructor-assessment.xhtml"))
				.addRule(Join.path("/profile/{studentId}/credentials/{credId}/assessments/instructor").to("/credential-instructor-assessment-profile.xhtml"))
				.addRule(Join.path("/credentials/{id}/assessments/peer").to("/credential-peer-assessments.xhtml"))
				.addRule(Join.path("/profile/{studentId}/credentials/{credId}/assessments/peer").to("/credential-peer-assessments-profile.xhtml"))
				.addRule(Join.path("/credentials/{id}/assessments/peer/{assessmentId}").to("/credential-assessment.xhtml"))
                .addRule(Join.path("/profile/{studentId}/credentials/{credId}/assessments/peer/{assessmentId}").to("/credential-assessment-profile.xhtml"))
				...
				.addRule(Join.path("/profile/{studentId}/competences/{compId}/assessments/self").to("/competence-self-assessment-profile.xhtml"))
				.addRule(Join.path("/competences/{compId}/assessments/instructor").to("/competence-instructor-assessments.xhtml"))
				.addRule(Join.path("/profile/{studentId}/competences/{compId}/assessments/instructor").to("/competence-instructor-assessments-profile.xhtml"))
				.addRule(Join.path("/competences/{compId}/assessments/instructor/{assessmentId}").to("/competence-instructor-assessment.xhtml"))
                .addRule(Join.path("/profile/{studentId}/competences/{compId}/assessments/instructor/{assessmentId}").to("/competence-instructor-assessment-profile.xhtml"))
                .addRule(Join.path("/competences/{compId}/assessments/peer").to("/competence-peer-assessments.xhtml"))
				.addRule(Join.path("/profile/{studentId}/competences/{compId}/assessments/peer").to("/competence-peer-assessments-profile.xhtml"))
				.addRule(Join.path("/competences/{compId}/assessments/peer/{assessmentId}").to("/competence-peer-assessment.xhtml"))
				.addRule(Join.path("/profile/{studentId}/competences/{compId}/assessments/peer/{assessmentId}").to("/competence-peer-assessment-profile.xhtml"))
