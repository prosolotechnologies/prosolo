...
public class RewriteConfigurationProvider extends HttpConfigurationProvider {
	...
	public Configuration getConfiguration(final ServletContext context) {
		return ConfigurationBuilder.begin()
				...
				.addRule(Join.path("/profile/{studentId}/{credId}/assessments/instructor").to("/credential-instructor-assessment-public.xhtml"))
				.addRule(Join.path("/credentials/{id}/assessments/peer").to("/credential-peer-assessments.xhtml"))
				.addRule(Join.path("/profile/{studentId}/{credId}/assessments/peer").to("/credential-peer-assessments-public.xhtml"))
