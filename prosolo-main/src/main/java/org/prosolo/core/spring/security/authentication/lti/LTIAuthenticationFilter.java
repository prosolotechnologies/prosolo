...
public class LTIAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException, IOException, ServletException {
        try {
            ...
            LtiTool ltiTool = validateToolLaunchAndReturnLtiTool(msg, request);
    ...
    private LtiTool validateToolLaunchAndReturnLtiTool(LTILaunchMessage msg, HttpServletRequest request) {
