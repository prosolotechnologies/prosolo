...
#2017022701_v0.7-credential_redesign.sql
...
#2017022801_v0.7-competence_group_inherited.sql
...
#2017030201_v0.7-archived-competence.sql
ALTER TABLE `competence1`
  ADD COLUMN `archived` char(1) COLLATE utf8_bin DEFAULT 'F';

#2017031501_v0.7-comp-and-activity-changes.sql
ALTER TABLE `competence1`
...
#2017040401_v0.7-credential_changes.sql
ALTER TABLE `credential1`
  ADD COLUMN `archived` char(1) COLLATE utf8_bin DEFAULT 'F',
  ADD COLUMN `version` bigint(20) DEFAULT 0;

#2017041101_v0.7-inherited_privileges.sql
ALTER TABLE `competence_user_group`
...
#2017051501_v0.7-credential-user-group-unique-constraint.sql
...
#2017051701_v0.7-domain_model_for_organizations.sql
...
#2017060801_v0.7-assessment_constraints.sql
...
#2017070501_v0.7-activity-tags.sql
...
#2017070501_v0.7-unit_name_and_organization_name_contraint.sql
ALTER TABLE `unit`
...
#2017080101_v0.7-user_group_unit_relationship.sql
ALTER TABLE `user_group`
  ADD COLUMN `unit` bigint(20) DEFAULT NULL,
  ADD CONSTRAINT `FK_user_group_unit` FOREIGN KEY (`unit`) REFERENCES `unit` (`id`);

#2017081501_v0.7-credential_and_competence_organization_relationship.sql
ALTER TABLE `credential1`
  ADD COLUMN `organization` bigint(20) DEFAULT NULL,
...
#2017081801_v0.7-deleting_old_tables_from_0.6.sql
